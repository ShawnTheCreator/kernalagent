#pragma checksum "C:\Users\anime\3D Objects\Ghost\Desktop-App\Kernel Agent\HistoryPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "E901857F393B3A52609B80754AEB84FDBFBF28C3FC38BA22F0B35F431D44F2DA"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Kernel_Agent
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
        ...
        {
            private global::Kernel_Agent.Services.TimelineEventDto dataRoot;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 41 && columnNumber == 101)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_(global::WinRT.CastExtensions.As<global::Kernel_Agent.Services.TimelineEventDto>(item), 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = global::WinRT.CastExtensions.As<global::Kernel_Agent.Services.TimelineEventDto>(newDataRoot);
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::Kernel_Agent.Services.TimelineEventDto obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_DisplayColor(obj.DisplayColor, phase);
            ...
            private void Update_DisplayColor(global::Microsoft.UI.Xaml.Media.SolidColorBrush obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // HistoryPage.xaml line 41
        ...
        private partial class HistoryPage_obj1_Bindings :
            ...
            IHistoryPage_Bindings
        {
            private global::Kernel_Agent.HistoryPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 2: // HistoryPage.xaml line 22
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = global::WinRT.CastExtensions.As<global::Kernel_Agent.HistoryPage>(newDataRoot);
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::Kernel_Agent.HistoryPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_TimelineEvents(obj.TimelineEvents, phase);
                    }
                }
            }
            private void Update_TimelineEvents(global::System.Collections.ObjectModel.ObservableCollection<global::Kernel_Agent.Services.TimelineEventDto> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // HistoryPage.xaml line 22
        ...
        public void Connect(int connectionId, object target)
        {
            switch(connectionId)
            {
            case 8: // HistoryPage.xaml line 17
                {
                ...
                break;
            case 9: // HistoryPage.xaml line 18
                {
